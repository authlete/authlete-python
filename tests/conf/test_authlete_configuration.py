...
class TestAuthleteConfiguration(unittest.TestCase):
    def test_1(self):
        cnf = AuthleteConfiguration()

        cnf.baseUrl                 = "B"
        cnf.serviceOwnerApiKey      = "SO_K"
        cnf.serviceOwnerApiSecret   = "SO_S"
        cnf.serviceOwnerAccessToken = "SO_T"
        cnf.serviceApiKey           = "S_K"
        cnf.serviceApiSecret        = "S_S"
        cnf.serviceAccessToken      = "S_T"
