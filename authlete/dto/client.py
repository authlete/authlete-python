...
class Client(Jsonable):
    def __init__(self, nameAndValues=None):
        nameAndTypes = {
            ...
            'authorizationDetailsTypes':                   str,                     # list of str
            'parRequired':                                 bool,
            ...
            'rsSignedRequestKeyId':                        str,
            'rsRequestSigned':                             bool,
            'dpopRequired':                                bool,
            'locked':                                      bool,
            'fapiModes':                                   FapiMode,                # list of FapiMode
            'entityId':                                    str,
            'trustAnchorId':                               str,
            'trustChain':                                  str,                     # list of str
            'trustChainExpiresAt':                         int,
            'trustChainUpdatedAt':                         int,
            'organizationName':                            str,
            'signedJwksUri':                               str,
            'clientRegistrationTypes':                     ClientRegistrationType,  # list of ClientRegistrationType
            'automaticallyRegistered':                     bool,
            'explicitlyRegistered':                        bool,
            'credentialOfferEndpoint':                     str,
            'credentialResponseEncryptionRequired':        bool
        }
